...
/*
     FILE ARCHIVED ON 2:15:42 Jun 29, 2015 AND RETRIEVED FROM THE
...
function onloadHandler() {
	...
	messageBox.show( "<br/>\n" +
			 ...
			 "<a href=\"/web/20150629021542/http://get.webgl.org/\" target=\"_new\">/web/20150629021542/http://get.webgl.org/</a><br/>\n" 
    ...
    //   /web/20150629021542/http://stackoverflow.com/questions/5448545/how-to-retrieve-get-parameters-from-javascript
...
function about() {
    ...
    messageBox.show( 
	    ...
	    "<br/>\n" +
	    "<a href=\"/web/20150629021542/https://github.com/IkarosKappler/extrusiongen\" target=\"_blank\">Ikaros Kappler @ github</a><br/>\n" +
...
/**
 * Thanks to
 *  /web/20150629021542/http://www.w3schools.com/js/js_cookies.asp
 **/
...
function get3DScreenshotData() {
    ...
    // /web/20150629021542/http://stackoverflow.com/questions/15558418/how-do-you-save-an-image-from-a-three-js-canvas
...
function order_print() {
	...
	"<ul>\n" +
	"  <li>\n" +
	"    <a href=\"/web/20150629021542/http://3d-druck-shop.youin3d.com/online-kaufen/3d-drucker-reprap-zubehoer-einzelteile-bausaetze-kits-ersatzteile/dildogenerator-gussform-3d-gedruckte-gussform-und-silikon-fuer-3d-druck-sexspielzeug/\" target=\"_blank\">Order without silicone (just the mold)</a>\n" +
	"    </a>\n" +
	"  </li>\n" +
	"  <li>\n" +
	"    <a href=\"/web/20150629021542/http://3d-druck-shop.youin3d.com/online-kaufen/3d-drucker-reprap-zubehoer-einzelteile-bausaetze-kits-ersatzteile/dildogenerator-diy-kit-silikon-fuer-3d-druck-sexspielzeug-gussform/\" target=\"_blank\">Order with silicone</a>\n" +
	"  </li>\n" +
	"</ul>\n" +
